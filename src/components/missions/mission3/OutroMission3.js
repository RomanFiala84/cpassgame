...
const OutroMission3 = () => {
  ...
  const savePreferences = async () => {
    ...
    try {
      ...
      // ✅ ZMENENÉ: mission4
      progress.wants_to_participate_mission4 = wantsParticipate;
      progress.participation_mission4_response_timestamp = new Date().toISOString();

      if (wantsNotification) {
        const finalEmail = emailOption === 'new' ? newEmail : existingEmail;
        // ✅ ZMENENÉ: mission4
        progress.wants_notification_mission4 = true;
        progress.notification_mission4_email_option = emailOption;
        progress.notification_mission4_email = finalEmail;
        progress.notification_mission4_timestamp = new Date().toISOString();
      } else {
        // ✅ ZMENENÉ: mission4
        progress.wants_notification_mission4 = false;
      }
