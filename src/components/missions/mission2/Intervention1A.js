...
const Page1Content = ({ setLandmark }) => (
  <>
    <div ref={setLandmark('p1_module')}><ModuleTitle>🧠 Konšpiračné presvedčenia</ModuleTitle></div>
    <div ref={setLandmark('p1_s1')}><SectionTitle>Čo je to vlastne konšpiračné presvedčenie?</SectionTitle></div>
    <BodyText>
    ...
    <Divider />
    <div ref={setLandmark('p1_s2')}><SectionTitle>Aké sú ich spoločné znaky?</SectionTitle></div>
    <BodyText>
    ...
    <Divider />
    <div ref={setLandmark('p1_s3')}><SectionTitle>Prečo sa im darí?</SectionTitle></div>
    <BodyText>
    ...
    <Divider />
    <div ref={setLandmark('p1_s4')}><SectionTitle>Ako vznikajú?</SectionTitle></div>
    ...
    <Divider />
    <div ref={setLandmark('p1_s5')}><SectionTitle>Prečo ich ľudia šíria?</SectionTitle></div>
    ...
    <Divider />
    <div ref={setLandmark('p1_s6')}><SectionTitle>Sebareflexia — otázky, ktoré ti pomôžu</SectionTitle></div>
    <BodyText>
...
const Page2Content = ({ setLandmark }) => (
  <>
    <div ref={setLandmark('p2_module')}><ModuleTitle>🏛️ Inštitúcie EÚ</ModuleTitle></div>
    <div ref={setLandmark('p2_s1')}><SectionTitle>Aké sú inštitúcie EÚ a čo robia?</SectionTitle></div>
    ...
    <Divider />
    <div ref={setLandmark('p2_s2')}><SectionTitle>Ako EÚ zabezpečuje transparentnosť?</SectionTitle></div>
    <BodyText>
    ...
    <Divider />
    <div ref={setLandmark('p2_s3')}><SectionTitle>Čo EÚ robí pre vás?</SectionTitle></div>
    <BodyText>
...
const Page3Content = ({ setLandmark }) => (
  <>
    <div ref={setLandmark('p3_module')}><ModuleTitle>🚦 Príspevkový semafor</ModuleTitle></div>
    <div ref={setLandmark('p3_s1')}><SectionTitle>Základné tri otázky</SectionTitle></div>
    <BodyText>
    ...
    <Divider />
    <div ref={setLandmark('p3_s2')}><SectionTitle>🔴 Červená — znaky manipulatívneho príspevku</SectionTitle></div>
    ...
    <Divider />
    <div ref={setLandmark('p3_s3')}><SectionTitle>🟠 Oranžová — znaky neistého príspevku</SectionTitle></div>
    ...
    <Divider />
    <div ref={setLandmark('p3_s4')}><SectionTitle>🟢 Zelená — znaky dôveryhodného príspevku</SectionTitle></div>
...
const Intervention1A = () => {
  ...
  const responseManager           = useMemo(() => getResponseManager(dataManager), [dataManager]); // ✅ memoizované
  ...
  // ✅ Reset startTime pri každej zmene stránky
  useEffect(() => {
  ...
  return (
    <Layout>
      <Container> {/* ✅ ref na Container, nie Card — scrolluje window */}
